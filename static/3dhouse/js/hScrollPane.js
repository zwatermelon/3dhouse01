	...
	$.fn.hScrollPane=function(settings){
		...
		this.each(function(){
			...
			if(settings.showArrow){
				...
				console.log(leftArrow.outerWidth()*2);  // 0
				console.log(container.width()-leftArrow.outerWidth()*2); //0
				dragbar.css({
					//width:container.width()-leftArrow.outerWidth()*2,  // = 0 ?
					width : 580 + "px",
